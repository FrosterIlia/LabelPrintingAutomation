...
class PrinterManager:
    ...
    def _direct_print_windows(self, image_path: str, printer_name: str) -> bool:
    ...
    def print_image(self, image_path: str, printer_name: str) -> bool:
        ...
        try:
            ...
            if self.is_windows:
                success = self._direct_print_windows(print_path, printer_name)
            else:
                success = self._mock_print(print_path, printer_name)
